...
class variante(models.Model):
    ...
    modelo_v = fields.Char(string="Modelo")
    aplica_v = fields.Char(string="Aplica")
    capacidad_v = fields.Char(string="Capacidad")
    cantidad_unidad_v = fields.Float(string="Cantidad por Unidad")
    equipo_v = fields.Selection([('Si', 'Si'), ('No', 'No')])
    estado_v = fields.Selection([('Verificado', 'Verificado'), ('No verificado', 'No verificado')])
    marca_v = fields.Char(string="Marca")

class lote(models.Model):
    _inherit = 'stock.production.lot'
    
    lote_capacidad = fields.Char(string="Capacidad", related='product_id.capacidad_v')
    lote_equipos_compuestos = fields.Selection(string="Equipos Compuestos", related="product_id.equipo_v")
    ...
    lote_marca = fields.Char(string="Marca", related='product_id.marca_v')
    lote_modelo = fields.Char(string="Modelo", related='product_id.modelo_v')
